...
func run() error {
	...
	api := &apiHandler{cp: cpHandler, id: identityHandler, rs: rosterHandler, at: attendanceHandler, lv: liveviewHandler}
	...
	handler := httpserver.New(httpserver.Deps{
		...
		TenantRoutePrefixes: []string{"/departments", "/employees", "/roles", "/shifts", "/locations", "/attendance", "/live", "/me/shifts"},
	})
